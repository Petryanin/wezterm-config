...
-- stylua: ignore
local colors = {
   text_default          = { bg = Colors.tab_bar.inactive_tab.bg_color, fg = Colors.tab_bar.inactive_tab.fg_color },
   text_hover            = { bg = Colors.tab_bar.inactive_tab_hover.bg_color, fg = Colors.tab_bar.inactive_tab_hover.fg_color },
   text_active           = { bg = Colors.tab_bar.active_tab.bg_color, fg = Colors.tab_bar.active_tab.fg_color },

   unseen_output_default = { bg = Colors.tab_bar.inactive_tab.bg_color, fg = Colors.ansi[7] },
   unseen_output_hover   = { bg = Colors.tab_bar.inactive_tab_hover.bg_color, fg = Colors.ansi[7] },
   unseen_output_active  = { bg = Colors.tab_bar.active_tab.bg_color, fg = Colors.ansi[7] },

   scircle_default       = { bg = Colors.background, fg = Colors.tab_bar.inactive_tab.bg_color },
   scircle_hover         = { bg = Colors.background, fg = Colors.tab_bar.inactive_tab_hover.bg_color },
   scircle_active        = { bg = Colors.background, fg = Colors.tab_bar.active_tab.bg_color },
}
...
function Tab:set_info(event_opts, tab, max_width)
   ...
   if self.title_locked then
      self.title = create_title(tab.tab_index + 1, '', self.locked_title, max_width, inset)
      return
   end
   self.title = create_title(tab.tab_index + 1, process_name, tab.active_pane.title, max_width, inset)
end
